...
public class CourseUsersDao extends BaseDao {

	private static final Log log = LogFactory.getLog(CourseUsersDao.class);
	private static final String entityFullName = CourseUsers.class.getName();
	private static final String entitySimpleName = CourseUsers.class.getSimpleName();

	public void create(CourseUsers transientInstance) {
	...
	public CourseUsers read(int id) {
		log.debug("reading " + entitySimpleName + " instance with id: " + id);
		CourseUsers instance = null;
		
		try {
			instance = (CourseUsers)super.read(entityFullName, id);
	...
	public List<CourseUsers> readAll() {
		log.debug("readAll " + entitySimpleName);
		List<CourseUsers> result = null;
		
		try {
			result = (List<CourseUsers>)super.readAll(entityFullName, new CourseUsers());
	...
	public void update(CourseUsers instance) {
	...
	public void delete(CourseUsers persistentInstance) {
