...
public class AssignmentsDao extends BaseDao{
	...
	private static final Log log = LogFactory.getLog(AssignmentsDao.class);
	private static final String entityFullName = Assignments.class.getName();
	private static final String entitySimpleName = Assignments.class.getSimpleName();
	...
	public Assignments read(int id) {
		...
		try {
			instance = (Assignments)super.read(entityFullName, id);
	...
	public void delete(Assignments persistentInstance) {
