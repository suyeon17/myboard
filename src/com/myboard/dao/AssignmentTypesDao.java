...
public class AssignmentTypesDao extends BaseDao {

	private static final Log log = LogFactory.getLog(AssignmentTypesDao.class);
	private static final String entityFullName = AssignmentTypes.class.getName();
	private static final String entitySimpleName = AssignmentTypes.class.getSimpleName();

	public void create(AssignmentTypes transientInstance) {
	...
	public AssignmentTypes read(int id) {
		...
		try {
			instance = (AssignmentTypes)super.read(entityFullName, id);
	...
	public void update(AssignmentTypes instance) {
	...
	public void delete(AssignmentTypes persistentInstance) {
